...
func NewOperationalDataRequestStruct(startMonth, start int32) *operationaldata.OperationalDataRequestStruct {
	return &operationaldata.OperationalDataRequestStruct{
...
func main() {
	...
	flag.IntVar(&port, "p", 30029, "Specify port")
	...
	res, _ := client.GetOperationalData(odrs)
	fmt.Println(res)
	switch cmd {
	case "":
		Usage()
