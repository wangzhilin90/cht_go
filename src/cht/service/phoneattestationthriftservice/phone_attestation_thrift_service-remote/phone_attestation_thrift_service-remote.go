...
func main() {
	...
	case "checkPhoneUse":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "CheckPhoneByPhone requires 1 args")
			flag.Usage()
		}
		arg8 := flag.Arg(1)
		...
		value0 := argvalue0
		fmt.Print(client.CheckPhoneByPhone(value0))
		fmt.Print("\n")
		break
	...
	case "updatePhone":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "UpdatePhoneByTransaction requires 1 args")
			flag.Usage()
		}
		arg20 := flag.Arg(1)
		...
		value0 := argvalue0
		fmt.Print(client.UpdatePhoneByTransaction(value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
