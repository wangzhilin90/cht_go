...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  BorrowUserDetailsResponseStruct getBorrowerInfo(BorrowUserDetailsRequestStruct requestObj)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := borrowerthriftservice.NewBorrowerThriftServiceClientFactory(trans, protocolFactory)
