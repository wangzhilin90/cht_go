//登录服务
namespace php User.UserLogin
namespace go userloginservice

struct UserLoginRequestStruct {
...
service UserLoginThriftService {
    UserLoginResponseStruct getUserLoginInfo (1:UserLoginRequestStruct requestObj)
}