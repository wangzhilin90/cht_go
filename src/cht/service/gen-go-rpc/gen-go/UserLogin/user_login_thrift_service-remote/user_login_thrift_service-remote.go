...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  UserLoginResponseStruct getUserLoginInfo(UserlLoginRequestStruct requestObj)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := UserLogin.NewUserLoginThriftServiceClientFactory(trans, protocolFactory)
  ...
  case "getUserLoginInfo":
    ...
    argvalue0 := UserLogin.NewUserlLoginRequestStruct()
    ...
    value0 := argvalue0
    fmt.Print(client.GetUserLoginInfo(value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
