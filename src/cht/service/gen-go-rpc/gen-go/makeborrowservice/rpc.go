...
type CouponListThriftService interface {
	// Parameters:
	//  - RequestObj
	GetCoupon(requestObj *MakeBorrowRequestStruct) (r *MakeBorrowResponseStruct, err error)
}
...
// Parameters:
//  - RequestObj
func (p *CouponListThriftServiceClient) GetCoupon(requestObj *MakeBorrowRequestStruct) (r *MakeBorrowResponseStruct, err error) {
...
func (p *CouponListThriftServiceClient) sendGetCoupon(requestObj *MakeBorrowRequestStruct) (err error) {
...
func (p *CouponListThriftServiceClient) recvGetCoupon() (value *MakeBorrowResponseStruct, err error) {
...
func NewCouponListThriftServiceProcessor(handler CouponListThriftService) *CouponListThriftServiceProcessor {
	...
	self2 := &CouponListThriftServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self2.processorMap["getCoupon"] = &couponListThriftServiceProcessorGetCoupon{handler: handler}
	return self2
}
...
var CouponListThriftServiceGetCouponArgs_RequestObj_DEFAULT *MakeBorrowRequestStruct

func (p *CouponListThriftServiceGetCouponArgs) GetRequestObj() *MakeBorrowRequestStruct {
...
var CouponListThriftServiceGetCouponResult_Success_DEFAULT *MakeBorrowResponseStruct

func (p *CouponListThriftServiceGetCouponResult) GetSuccess() *MakeBorrowResponseStruct {
	if !p.IsSetSuccess() {
