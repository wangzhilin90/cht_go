...
func (p *UserCouponListResponseStruct)  ReadField1(iprot thrift.TProtocol) error {
  ...
  p.UserCouponList =  tSlice
  for i := 0; i < size; i ++ {
    _elem0 := &UserCouponDetailsStruct{}
    if err := _elem0.Read(iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem0), err)
    }
    p.UserCouponList = append(p.UserCouponList, _elem0)
  }
...
func (p *UserCouponListResponseStruct) writeField1(oprot thrift.TProtocol) (err error) {
  ...
  for _, v := range p.UserCouponList {
...
func (p *UserCouponListThriftServiceClient) GetUserCouponList(requestObj *UserCouponListRequestStruct) (r *UserCouponListResponseStruct, err error) {
  if err = p.sendGetUserCouponList(requestObj); err != nil { return }
