namespace php SysUser.SysUserList
namespace go  sysuserlist

//后台管理员列表

struct SysUserListRequestStruct {
...
struct SysUserListResponseStruct {
	1:i32 status,
    2:list<SysUserDetailsStruct> SysUserList
	3:string msg,
}

service SysUserListThriftService {
    SysUserListResponseStruct getSysUserList (1:SysUserListRequestStruct requestObj)
}