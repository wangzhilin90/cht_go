...
func NewCollectionRequestStruct(user_id, start, end, search, status, offset, limit int32, borrowid string) *UserCollectionListRequestStruct {
...
func TestGetCollectionList(t *testing.T) {
	...
	res, err := cs.GetUserCollectionList(tcs)
	if err != nil {
