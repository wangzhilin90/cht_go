...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  JuanzengResponseStruct getInfo(RequestStruct requestObj)")
  fmt.Fprintln(os.Stderr, "  i32 addMess(RequestStruct requestObj)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := juanzengthriftservice.NewJuanzengThriftServiceClientFactory(trans, protocolFactory)
  ...
  case "getInfo":
    ...
    argvalue0 := juanzengthriftservice.NewRequestStruct()
  ...
  case "addMess":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "AddMess requires 1 args")
      flag.Usage()
    }
    arg14 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.AddMess(value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
