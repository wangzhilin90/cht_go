...
func main() {
	...
	client := messagethriftservice.NewMessageThriftServiceClientFactory(trans, protocolFactory)
	...
	case "getMessageInfo":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "GetMessageDetails requires 1 args")
			flag.Usage()
		}
		arg6 := flag.Arg(1)
		...
		value0 := argvalue0
		fmt.Print(client.GetMessageDetails(value0))
		fmt.Print("\n")
		break
